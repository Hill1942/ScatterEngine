...
int Game_Main(void *param)
{
    ...
    */
	...
	myobj.dir.y+=100;
	if (myobj.dir.y >= 360) myobj.dir.y = 0;
	...
	Build_XYZ_Rotation_Matrix4X4(100, myobj.dir.y, 100, &mrot);

	//if (++ang_y >= 360.0) ang_y = 0;

	Transform_OBJECT4DV1(&myobj, &mrot, TRANSFORM_LOCAL_TO_TRANS, 1);

	Model_To_Word_OBJECT4DV1(&myobj, TRANSFORM_TRANS_ONLY);

	Insert_OBJECT4DV1_RENDERLIST4DV1(&rend_list, &myobj, 0);
